...
#define WIND(s) -max((0.15*log(2.*(s-roughY0u)+1.)),0.)   // log Wind profile 
...
double Lambda = 0.00000000000001, bd = 0.;   // Grass coupling
#define STRAT(s) gCONST/TREF*(log(30*s + a1 + 1.) - log(a1 + 1.)) + (QFLX/Lambda + bd)
//#define STRAT(s) gCONST/TREF*s
double a1 = 0.;
